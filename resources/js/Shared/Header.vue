...
function toggleSidebar() {
    if (sidebarToggle) sidebarToggle.value = !sidebarToggle.value;
}
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            fill-rule="evenodd"
                                            clip-rule="evenodd"
                                            d="M9 1.5C6.79086 1.5 5 3.29086 5 5.5V7H4.5C3.39543 7 2.5 7.89543 2.5 9V14C2.5 15.1046 3.39543 16 4.5 16H13.5C14.6046 16 15.5 15.1046 15.5 14V9C15.5 7.89543 14.6046 7 13.5 7H13V5.5C13 3.29086 11.2091 1.5 9 1.5ZM6.5 5.5C6.5 4.11929 7.61929 3 9 3C10.3807 3 11.5 4.11929 11.5 5.5V7H6.5V5.5ZM4 9C4 8.72386 4.22386 8.5 4.5 8.5H13.5C13.7761 8.5 14 8.72386 14 9V14C14 14.2761 13.7761 14.5 13.5 14.5H4.5C4.22386 14.5 4 14.2761 4 14V9ZM9 10.5C9.41421 10.5 9.75 10.8358 9.75 11.25V12.25C9.75 12.6642 9.41421 13 9 13C8.58579 13 8.25 12.6642 8.25 12.25V11.25C8.25 10.8358 8.58579 10.5 9 10.5Z"
                                            fill=""
                                        />
                                    </svg>
                                    Change Password
